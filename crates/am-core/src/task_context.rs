...
const MANAGED_START: &str = "<!-- Perpetual task context start -->";
const MANAGED_END: &str = "<!-- Perpetual task context end -->";
...
fn render_context(context: &TaskContext) -> String {
    ...
    out.push_str("# Perpetual Task Context\n\n");
    out.push_str("This file is generated by Perpetual from the task context record.\n\n");
...
fn clean_value(value: &str) -> String {
    value
        .replace(MANAGED_START, "[Perpetual task context start]")
        .replace(MANAGED_END, "[Perpetual task context end]")
}
...
mod tests {
    ...
    fn render_context_includes_sections_and_empty_fallbacks() {
        ...
        assert!(rendered.contains("# Perpetual Task Context"));
